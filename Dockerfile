...
# apt-get の version を更新し、SQLite3 のインストール
...
# apps/detector の下に model.pt がいるからコピー不要
# COPY ./apps/detector/model.pt /usr/src/model.pt

# pip の version の更新
RUN pip install --upgrade pip

# Linux 用 Pytorch インストールコマンドを実行
